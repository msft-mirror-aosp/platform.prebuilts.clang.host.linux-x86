...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BINLIBDEST': '/tmpfs/src/git/out/python3/install/lib/python3.11',
 'BLDLIBRARY': '-L. -lpython3.11',
 'BLDSHARED': 'gcc -std=gnu11 -pthread -shared '
 ...
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wsign-compare -DNDEBUG -g  -O3 -Wall '
 ...
 'CONFINCLUDEPY': '/tmpfs/src/git/out/python3/install/include/python3.11',
 'COREPYTHONPATH': '',
 ...
 'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage '
                            ...
                            'git --git-dir '
                            '/tmpfs/src/git/external/python/cpython3/.git '
                            'rev-parse --short HEAD)]"',
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             '-I/tmpfs/src/git/external/python/cpython3/Include',
 'CXX': 'gcc -pthread',
 'DECIMAL_CFLAGS': '-I/tmpfs/src/git/external/python/cpython3/Modules/_decimal/libmpdec '
                   '-DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1',
 'DECIMAL_LDFLAGS': '-lm Modules/_decimal/libmpdec/libmpdec.a',
 'DEEPFREEZE_DEPS': '/tmpfs/src/git/external/python/cpython3/Tools/scripts/deepfreeze.py '
                    '_bootstrap_python '
                    '/tmpfs/src/git/external/python/cpython3/Programs/_freeze_module.py '
                    '\\',
 'DEEPFREEZE_OBJS': 'Python/deepfreeze/deepfreeze.o',
 'DESTDIRS': '/tmpfs/src/git/out/python3/install '
             '/tmpfs/src/git/out/python3/install/lib '
             '/tmpfs/src/git/out/python3/install/lib/python3.11 '
             '/tmpfs/src/git/out/python3/install/lib/python3.11/lib-dynload',
 'DESTLIB': '/tmpfs/src/git/out/python3/install/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/tmpfs/src/git/out/python3/install/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'EXE': '',
 'EXEMODE': 755,
 'EXPAT_CFLAGS': '-I/tmpfs/src/git/external/python/cpython3/Modules/expat',
 ...
 'INCLDIRSTOMAKE': '/tmpfs/src/git/out/python3/install/include '
                   ...
                   '/tmpfs/src/git/out/python3/install/include/python3.11 '
                   '/tmpfs/src/git/out/python3/install/include/python3.11',
 'INCLUDEDIR': '/tmpfs/src/git/out/python3/install/include',
 'INCLUDEPY': '/tmpfs/src/git/out/python3/install/include/python3.11',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -std=gnu11 -pthread -shared '
             '-Wno-unused-command-line-argument -s -Wl,-rpath,\\$ORIGIN/../lib '
             '-Wl,--as-needed  -L/tmpfs/src/git/out/libffi/install/lib64 '
             '-Wl,--exclude-libs=libffi.a',
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/tmpfs/src/git/out/python3/install/lib/python3.11',
 'LIBDIR': '/tmpfs/src/git/out/python3/install/lib',
 'LIBEXPAT_A': 'Modules/expat/libexpat.a',
 'LIBEXPAT_CFLAGS': '-I/tmpfs/src/git/external/python/cpython3/Modules/expat '
                    '-Wsign-compare -DNDEBUG -g  -O3 -Wall '
                    '-Wno-unused-command-line-argument -std=c11 -Wextra '
 ...
 'LIBMPDEC_CFLAGS': '-I/tmpfs/src/git/external/python/cpython3/Modules/_decimal/libmpdec '
                    '-DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 -Wsign-compare '
                    '-DNDEBUG -g  -O3 -Wall -Wno-unused-command-line-argument '
 ...
 'LIBPL': '/tmpfs/src/git/out/python3/install/lib/python3.11/config-3.11-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/tmpfs/src/git/out/python3/install/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -std=gnu11 -pthread',
 'MAJOR_IN_MKDEV': 0,
 ...
 'MODULE_UNICODEDATA_DEPS': '/tmpfs/src/git/external/python/cpython3/Modules/unicodedata_db.h '
                            '/tmpfs/src/git/external/python/cpython3/Modules/unicodename_db.h',
 ...
 'MODULE__BLAKE2_DEPS': '/tmpfs/src/git/external/python/cpython3/Modules/_blake2/impl/blake2-config.h '
                        '/tmpfs/src/git/external/python/cpython3/Modules/_blake2/impl/blake2-impl.h '
                        '/tmpfs/src/git/external/python/cpython3/Modules/_blake2/impl/blake2.h '
                        '/tmpfs/src/git/external/python/cpython3/Modules/_blake2/impl/blake2b-load-sse2.h '
                        '/tmpfs/src/git/external/python/cpython3/Modules/_blake2/impl/blake2b-load-sse41.h '
                        '/tmpfs/src/git/external/python/cpython3/Modules/_blake2/impl/blake2b-ref.c '
                        '/tmpfs/src/git/external/python/cpython3/Modules/_blake2/impl/blake2b-round.h '
                        '/tmpfs/src/git/external/python/cpython3/Modules/_blake2/impl/blake2b.c '
                        '/tmpfs/src/git/external/python/cpython3/Modules/_blake2/impl/blake2s-load-sse2.h '
                        '/tmpfs/src/git/external/python/cpython3/Modules/_blake2/impl/blake2s-load-sse41.h '
                        '/tmpfs/src/git/external/python/cpython3/Modules/_blake2/impl/blake2s-load-xop.h '
                        '/tmpfs/src/git/external/python/cpython3/Modules/_blake2/impl/blake2s-ref.c '
                        '/tmpfs/src/git/external/python/cpython3/Modules/_blake2/impl/blake2s-round.h '
                        '/tmpfs/src/git/external/python/cpython3/Modules/_blake2/impl/blake2s.c '
                        '/tmpfs/src/git/external/python/cpython3/Modules/_blake2/blake2module.h '
                        '/tmpfs/src/git/external/python/cpython3/Modules/hashlib.h',
 ...
 'MODULE__DECIMAL_CFLAGS': '-I/tmpfs/src/git/external/python/cpython3/Modules/_decimal/libmpdec '
                           '-DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1',
 'MODULE__DECIMAL_DEPS': '/tmpfs/src/git/external/python/cpython3/Modules/_decimal/docstrings.h '
 ...
 'MODULE__ELEMENTTREE_DEPS': '/tmpfs/src/git/external/python/cpython3/Modules/pyexpat.c '
 ...
 'MODULE__MD5_DEPS': '/tmpfs/src/git/external/python/cpython3/Modules/hashlib.h',
 ...
 'MODULE__SHA1_DEPS': '/tmpfs/src/git/external/python/cpython3/Modules/hashlib.h',
 'MODULE__SHA1_STATE': 'yes',
 'MODULE__SHA256_DEPS': '/tmpfs/src/git/external/python/cpython3/Modules/hashlib.h',
 'MODULE__SHA256_STATE': 'yes',
 'MODULE__SHA3_DEPS': '/tmpfs/src/git/external/python/cpython3/Modules/_sha3/sha3.c '
                      '/tmpfs/src/git/external/python/cpython3/Modules/_sha3/sha3.h '
                      '/tmpfs/src/git/external/python/cpython3/Modules/hashlib.h',
 'MODULE__SHA3_STATE': 'yes',
 'MODULE__SHA512_DEPS': '/tmpfs/src/git/external/python/cpython3/Modules/hashlib.h',
 'MODULE__SHA512_STATE': 'yes',
 'MODULE__SIGNAL_LDFLAGS': '',
 'MODULE__SOCKET_DEPS': '/tmpfs/src/git/external/python/cpython3/Modules/socketmodule.h '
                        '/tmpfs/src/git/external/python/cpython3/Modules/addrinfo.h '
                        '/tmpfs/src/git/external/python/cpython3/Modules/getaddrinfo.c '
                        '/tmpfs/src/git/external/python/cpython3/Modules/getnameinfo.c',
 'MODULE__SOCKET_STATE': 'yes',
 'MODULE__SQLITE3_DEPS': '/tmpfs/src/git/external/python/cpython3/Modules/_sqlite/connection.h '
                         '/tmpfs/src/git/external/python/cpython3/Modules/_sqlite/cursor.h '
                         '/tmpfs/src/git/external/python/cpython3/Modules/_sqlite/microprotocols.h '
                         '/tmpfs/src/git/external/python/cpython3/Modules/_sqlite/module.h '
                         '/tmpfs/src/git/external/python/cpython3/Modules/_sqlite/prepare_protocol.h '
                         '/tmpfs/src/git/external/python/cpython3/Modules/_sqlite/row.h '
                         '/tmpfs/src/git/external/python/cpython3/Modules/_sqlite/util.h',
 'MODULE__SQLITE3_STATE': 'disabled',
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_DEPS': '/tmpfs/src/git/external/python/cpython3/Modules/_ssl.h '
                     '/tmpfs/src/git/external/python/cpython3/Modules/_ssl/cert.c '
                     '/tmpfs/src/git/external/python/cpython3/Modules/_ssl/debughelpers.c '
                     '/tmpfs/src/git/external/python/cpython3/Modules/_ssl/misc.c '
                     '/tmpfs/src/git/external/python/cpython3/Modules/_ssl_data.h '
                     '/tmpfs/src/git/external/python/cpython3/Modules/_ssl_data_111.h '
                     '/tmpfs/src/git/external/python/cpython3/Modules/_ssl_data_300.h '
                     '/tmpfs/src/git/external/python/cpython3/Modules/socketmodule.h',
 ...
 'MODULE__TESTCAPI_DEPS': '/tmpfs/src/git/external/python/cpython3/Modules/testcapi_long.h',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wsign-compare -DNDEBUG -g  -O3 -Wall '
                             '-Wno-unused-command-line-argument -std=c11 '
 ...
 'PY_CFLAGS': '-Wsign-compare -DNDEBUG -g  -O3 -Wall '
              '-Wno-unused-command-line-argument',
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g  -O3 -Wall '
                   '-Wno-unused-command-line-argument -std=c11 -Wextra '
                   '-Wno-unused-parameter -Wno-missing-field-initializers '
                   '-Wstrict-prototypes -Werror=implicit-function-declaration '
                   '-fvisibility=hidden  '
 ...
 'PY_LDFLAGS': '-Wno-unused-command-line-argument -s '
               ...
               '-Wl,--exclude-libs=libffi.a',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '-Wno-unused-command-line-argument -s '
                     '-Wl,-rpath,\\$ORIGIN/../lib -Wl,--as-needed  '
                     '-L/tmpfs/src/git/out/libffi/install/lib64 '
                     '-Wl,--exclude-libs=libffi.a',
 ...
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/tmpfs/src/git/out/python3/build ./python -E '
 ...
 'WASM_STDLIB': './tmpfs/src/git/out/python3/install/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
