...
# Create imported target tf_xla_runtime
add_library(tf_xla_runtime STATIC IMPORTED)
...
set_target_properties(LLVMSupport PROPERTIES
  INTERFACE_LINK_LIBRARIES "rt;dl;-lpthread;m;ZLIB::ZLIB;zstd::libzstd_static;LLVMDemangle"
)
...
set_target_properties(LLVMCodeGen PROPERTIES
  INTERFACE_LINK_LIBRARIES "-lpthread;tf_xla_runtime;LLVMAnalysis;LLVMBitReader;LLVMBitWriter;LLVMCodeGenTypes;LLVMCore;LLVMMC;LLVMObjCARCOpts;LLVMProfileData;LLVMScalarOpts;LLVMSupport;LLVMTarget;LLVMTargetParser;LLVMTransformUtils"
)
...
set_target_properties(LLVMAnalysis PROPERTIES
  INTERFACE_LINK_LIBRARIES "tf_xla_runtime;LLVMBinaryFormat;LLVMCore;LLVMObject;LLVMProfileData;LLVMSupport;LLVMTargetParser"
)
...
set_target_properties(LLVMBOLTCore PROPERTIES
  INTERFACE_LINK_LIBRARIES "-lpthread;LLVMDebugInfoDWARF;LLVMDemangle;LLVMMC;LLVMMCDisassembler;LLVMObject;LLVMSupport;LLVMBinaryFormat;LLVMAsmPrinter;LLVMTargetParser;\$<LINK_ONLY:LLVMBOLTUtils>"
)
...
set_target_properties(LLVMBOLTPasses PROPERTIES
  INTERFACE_LINK_LIBRARIES "-lpthread;LLVMAsmPrinter;LLVMMC;LLVMSupport;LLVMTargetParser;LLVMTransformUtils;\$<LINK_ONLY:LLVMBOLTCore>;\$<LINK_ONLY:LLVMBOLTUtils>"
)
